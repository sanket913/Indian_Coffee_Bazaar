...
include 'header.php'; ?>
    <div class="admin-content-container">
        ...
        $limit = 10;
        $db = new Database();
        $db->select('products','products.product_id,products.product_code,products.product_cat,product_title,products.product_price,products.qty,products.product_status,products.featured_image',null,null,null);
        $result = $db->getResult();
        if (count($result) > 0) { ?>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="delete_product" href="javascript:void()" data-id="<?php echo $row['product_id'] ?>" data-cat="<?php echo $row['product_cat'] ?>"><i class="fa fa-trash"></i></a>
                        </td>
                    </tr>
                <?php } ?>
                </tbody>
